<template>
  <div class="@container">
    <div
      class="flex -rotate-1 -skew-x-3 flex-col gap-4 rounded-lg border border-slate-300 bg-gray-100 p-4 shadow-xl @4xl:flex-row @4xl:items-center @4xl:justify-center dark:border-slate-700 dark:bg-slate-900"
    >
      <p
        class="fix-bg-clip-text-safari self-center bg-gradient-to-tr from-pink-500 to-sky-500 bg-clip-text !p-2.5 text-6xl font-black text-transparent @xl:self-start @4xl:self-auto @4xl:text-5xl @5xl:text-7xl"
      >
        I'm on
      </p>
      <div
        v-if="browser.bundleId"
        class="my-8 flex aspect-square w-2/3 items-center self-center rounded-2xl bg-white @xl:w-1/2 @4xl:w-60 @4xl:self-auto dark:bg-slate-800"
      >
        <img
      ...
      <p
        class="fix-bg-clip-text-safari self-center bg-gradient-to-tl from-pink-500 to-sky-500 bg-clip-text !p-2.5 text-6xl font-black text-transparent @xl:self-end @4xl:self-auto @4xl:text-5xl @5xl:text-7xl"
      >
        right now.
      </p>
    </div>
