...
image:
  {
    src: '../../assets/reads/slop-fork-migrating-python-backend-to-bun-with-claude-code.jpg',
    alt: 'A developer sits in front of five monitors connected by glowing neon circuit lines branching from a central fork node. Left screens show Python code, right screens show TypeScript. A badge at the bottom reads 83/83 tests passed.',
  }
...
import coverImage from '../../assets/reads/slop-fork-migrating-python-backend-to-bun-with-claude-code.jpg'

<Image
  src={coverImage}
  alt="A developer sits in front of five monitors connected by glowing neon circuit lines branching from a central fork node. Left screens show Python code, right screens show TypeScript. A badge at the bottom reads 83/83 tests passed."
  caption="From Python to TypeScript: 109 commits, 5 parallel agents, and 83/83 smoke tests passing."
  lazy={false}
/>
