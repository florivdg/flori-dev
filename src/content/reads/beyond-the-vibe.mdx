...
import titleSlideImage from '../../assets/reads/beyond-the-vibe-slide-title.png'
...
The talk was in German, but the ideas aren't — so this post is the English, personal version of it. Not a slide-by-slide transcript (the <a href="/slides/ubt26-beyond-the-vibe/" target="_blank">full deck is online</a> if you want that), but the essence: **how I approach AI coding, and why I believe context, verification, and infrastructure matter more than the model you pick.**

<a href="/slides/ubt26-beyond-the-vibe/" target="_blank">
  <Image
    src={titleSlideImage}
    alt="Dark editor-styled title slide reading 'Beyond the Vibe' with 'Vibe' highlighted in cyan, subtitled 'Praktischer Einsatz von KI-Agenten im Entwicklungsalltag eines ISO-27001-zertifizierten Unternehmens.'"
    caption="The title slide — click it to browse the full deck."
  />
</a>
