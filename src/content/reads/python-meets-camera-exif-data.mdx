...
I have published the Python script on GitHub. You can find it [here](https://github.com/florivdg/exifExtractor). All you need is a Python environment and an OpenAI API key that is enabled for GPT-4 Vision.
